    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <form action="/datareklame/{{$reklame->kd_reklame}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="mb-3">
                                <label for="ukuran" class="form-label">Ukuran</label>
                                <input type="text" class="form-control" id="ukuran" name="ukuran" value="{{$reklame->ukuran}}">
                            </div>
                            <div class="mb-3">
                                <label for="harga" class="form-label">harga</label>
                                <input type="text" class="form-control" id="harga" name="harga" value="{{$reklame->harga}}">
                            </div>
                            <div class="mb-3">
                                <label for="alamat" class="form-label">Alamat</label>
                                <input type="text" class="form-control" id="alamat" name="alamat" value="{{$reklame->alamat}}">
                            </div>
                            <div class="mb-3">
                                ...
                                <select id="email" class="form-select" name="email">
                                    ...
                                    @foreach ($email as $e)
                                        ...
                                        @else
                                            ...
                                            @endphp
                                        @endif
                                        <option {{$select}} value="{{$e->email}}">{{$e->email}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="mb-3">
                                ...
                                <select id="kd_jenis" class="form-select" name="kd_jenis">
                                    ...
                                    @foreach ($jenis_reklame as $j)
                                        @if ($reklame->kd_jenis == $j->kd_jenis)
                                            @php
                                                $select = 'selected';
                                            @endphp
                                        @else
                                            ...
                                            @endphp
                                        @endif
                                        <option {{$select}} value="{{$j->kd_jenis}}">{{$j->nama_reklame}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="mb-3">
                                ...
                                <select id="kd_wilayah" class="form-select" name="kd_wilayah">
                                    ...
                                    @foreach ($wilayah as $w)
                                        @if ($reklame->kd_wilayah == $w->kd_wilayah)
                                            @php
                                                $select = 'selected';
                                            @endphp
                                        @else
                                            ...
                                            @endphp
                                        @endif
                                        <option {{$select}} value="{{$w->kd_wilayah}}">{{$w->nama_wilayah}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="row row-sm mg-t-20">
                                <input type="hidden" id="lat" class="form-control col-xs-5 col-md-5" name="lat" value="{{$reklame->lat}}">
                                <input type="hidden" id="lng" class="form-control col-xs-5 col-md-5" name="lng" value="{{$reklame->lng}}">
                            </div>
